package com.tarea7.dgmt07e02.Controladores;
...
import com.tarea7.dgmt07e02.Domain.sortDTO;
...
public class EmpleadoControlador {
    ...
    public String postIndexName(sortDTO sortform, Model model) {
        model.addAttribute("empleados", eServicio.listSorted(sortform.getSortgender(),sortform.getSortname()));
